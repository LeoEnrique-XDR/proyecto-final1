...
class RespuestaModel
{
    ...
    static public function registrarUsuario($tabla, $datos)
    {
        ...
        $stmt->bindParam(":clave", $datos['calve'], PDO::PARAM_STR);
    ...
    {
        $stmt = Conexion::conectar()->prepare("SELECT * FROM persona p JOIN usuario u ON p.id:persona=u.id_usuario WHERE p.id_persona=:id_persona");
